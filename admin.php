...
<?php
    echo "未登入成功或未註冊。<br>";
    echo "請回<a href='./index.php'>首頁</a>重新登入，或到<a href='./register.php'>註冊頁面</a>註冊。";
    exit();
...
<style>
    ...
    <?php
        echo "未註冊成功。<br>";
        echo "請回<a href='./register.php'>註冊頁面</a>重新註冊。";
        exit();
    }
    ?>
<!-- 設定一般樣式 -->
...
<div class="admin bg-light">
  ...
  <a class="navbar-brand" href="./admin.php">Nancybluebee</a>
